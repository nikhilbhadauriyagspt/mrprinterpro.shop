...
export default function PrivacyPolicy() {
  return (
    ...
    >
      <p className="lead">
                 This Privacy Notice for MrPrinterPro  ("we," "us," or "our"), describes how and why we might access, collect, store, use, and/or share ("process") your personal information when you use our services ("Services"), including when you:      </p>
      <ul>
        <li>Visit our website at <a href="http://mrprinterpro.shop/">http://mrprinterpro.shop/</a> or any website of ours that links to this Privacy Notice</li>
                 <li>Use Printers, Consumables & Accessories. MrPrinterPro is your trusted destination for authentic, high-performance printers and printing accessories from HP and other leading technology brands.</li>        <li>Engage with us in other related ways, including any marketing or events</li>
      </ul>
      <p>
        Questions or concerns? Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a href="mailto:info@mrprinterpro.shop">info@mrprinterpro.shop</a>.
      </p>

      <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm my-12 not-prose">
        <h2 className="text-2xl font-black text-gray-900 uppercase mt-0 mb-6 tracking-tighter">SUMMARY OF KEY POINTS</h2>
        <p className="text-sm text-gray-600 leading-relaxed space-y-4">
          This summary provides key points from our Privacy Notice, but you can find out more details about any of these topics by clicking the link following each key point or by using our table of contents below to find the section you are looking for.
        </p>
        <ul className="text-sm text-gray-600 space-y-4 mt-6 list-disc pl-5">
          ...
          <li><strong>How do we keep your information safe?</strong> We have adequate organizational and system processes and procedures in place to protect your personal information. However, no electronic transmission over the internet or information storage technology can be guaranteed to be 100% secure.</li>
      ...
      <p>Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <a href="http://mrprinterpro.shop/cookie-policy">http://mrprinterpro.shop/cookie-policy</a>.</p>
      ...
      <p><strong>In Short:</strong> We aim to protect your personal information through a system of organizational and system security measures.</p>
      <p>We have implemented appropriate and reasonable system and organizational security measures designed to protect the security of any personal information we process. However, despite our safeguards and efforts to secure your information, no electronic transmission over the Internet or information storage technology can be guaranteed to be 100% secure, so we cannot promise or guarantee that hackers, cybercriminals, or other unauthorized third parties will not be able to defeat our security and improperly collect, access, steal, or modify your information. Although we will do our best to protect your personal information, transmission of personal information to and from our Services is at your own risk. You should only access the Services within a secure environment.</p>
      ...
      <p><strong>Cookies and similar technologies:</strong> Most Web browsers are set to accept cookies by default. If you prefer, you can usually choose to set your browser to remove cookies and to reject cookies. If you choose to remove cookies or reject cookies, this could affect certain features or services of our Services. For further information, please see our Cookie Notice: <a href="http://mrprinterpro.shop/cookie-policy">http://mrprinterpro.shop/cookie-policy</a>.</p>
      <p>If you have questions or comments about your privacy rights, you may email us at <a href="mailto:info@mrprinterpro.shop">info@mrprinterpro.shop</a>.</p>
        ...
        <table className="w-full text-sm text-left text-gray-500 border border-gray-200">
          <thead className="text-xs text-gray-700 uppercase bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="px-6 py-3 border-r border-gray-200">Examples</th>
              <th className="px-6 py-3">Collected</th>
            </tr>
          </thead>
          <tbody>
            <tr className="border-b border-gray-200">
              <td className="px-6 py-4 font-bold text-gray-900 border-r border-gray-200">A. Identifiers</td>
              <td className="px-6 py-4 border-r border-gray-200">Contact details, such as real name, alias, postal address, telephone or mobile contact number, unique personal identifier, online identifier, Internet Protocol address, email address, and account name</td>
              <td className="px-6 py-4 text-gray-900 font-black">NO</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="px-6 py-4 font-bold text-gray-900 border-r border-gray-200">B. Personal information as defined in the California Customer Records statute</td>
              <td className="px-6 py-4 border-r border-gray-200">Name, contact information, education, employment, employment history, and financial information</td>
              <td className="px-6 py-4 text-gray-900 font-black">NO</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="px-6 py-4 font-bold text-gray-900 border-r border-gray-200">C. Protected classification characteristics under state or federal law</td>
              <td className="px-6 py-4 border-r border-gray-200">Gender, age, date of birth, race and ethnicity, national origin, marital status, and other demographic data</td>
              <td className="px-6 py-4 text-gray-900 font-black">NO</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="px-6 py-4 font-bold text-gray-900 border-r border-gray-200">D. Commercial information</td>
              <td className="px-6 py-4 border-r border-gray-200">Transaction information, purchase history, financial details, and payment information</td>
              <td className="px-6 py-4 text-gray-900 font-black">NO</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="px-6 py-4 font-bold text-gray-900 border-r border-gray-200">E. Biometric information</td>
              <td className="px-6 py-4 border-r border-gray-200">Fingerprints and voiceprints</td>
              <td className="px-6 py-4 text-gray-900 font-black">NO</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="px-6 py-4 font-bold text-gray-900 border-r border-gray-200">F. Internet or other similar network activity</td>
              <td className="px-6 py-4 border-r border-gray-200">Browsing history, search history, online behavior, interest data, and interactions with our and other websites, applications, systems, and advertisements</td>
              <td className="px-6 py-4 text-gray-900 font-black">NO</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="px-6 py-4 font-bold text-gray-900 border-r border-gray-200">G. Geolocation data</td>
              <td className="px-6 py-4 border-r border-gray-200">Device location</td>
              <td className="px-6 py-4 text-gray-900 font-black">NO</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="px-6 py-4 font-bold text-gray-900 border-r border-gray-200">H. Audio, electronic, sensory, or similar information</td>
              <td className="px-6 py-4 border-r border-gray-200">Images and audio, video or call recordings created in connection with our business activities</td>
              <td className="px-6 py-4 text-gray-900 font-black">NO</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="px-6 py-4 font-bold text-gray-900 border-r border-gray-200">I. Professional or employment-related information</td>
              <td className="px-6 py-4 border-r border-gray-200">Business contact details in order to provide you our Services at a business level or job title, work history, and professional qualifications if you apply for a job with us</td>
              <td className="px-6 py-4 text-gray-900 font-black">NO</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="px-6 py-4 font-bold text-gray-900 border-r border-gray-200">J. Education Information</td>
              <td className="px-6 py-4 border-r border-gray-200">Student records and directory information</td>
              <td className="px-6 py-4 text-gray-900 font-black">NO</td>
            </tr>
            <tr className="border-b border-gray-200">
              <td className="px-6 py-4 font-bold text-gray-900 border-r border-gray-200">K. Inferences drawn from collected personal information</td>
              <td className="px-6 py-4 border-r border-gray-200">Inferences drawn from any of the collected personal information listed above to create a profile or summary about, for example, an individual’s preferences and characteristics</td>
              <td className="px-6 py-4 text-gray-900 font-black">NO</td>
            </tr>
            <tr>
              <td className="px-6 py-4 font-bold text-gray-900 border-r border-gray-200">L. Sensitive personal Information</td>
              <td className="px-6 py-4 border-r border-gray-200">None</td>
              <td className="px-6 py-4 text-gray-900 font-black">NO</td>
            </tr>
          </tbody>
        </table>
      ...
      <p>We may use your personal information for our own business purposes, such as for undertaking internal research for operational development and demonstration. This is not considered to be "selling" of your personal information.</p>
      ...
      <h3>How to Exercise Your Rights</h3>
             <p>To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at info@mrprinterpro.shop, by visiting <a href="http://mrprinterpro.shop/contact">http://mrprinterpro.shop/contact</a>, or by referring to the contact details at the bottom of this document.</p>      <p>Under certain US state data protection laws, you can designate an authorized agent to make a request on your behalf. We may deny a request from an authorized agent that does not submit proof that they have been validly authorized to act on your behalf in accordance with applicable laws.</p>
      ...
      <h3>Appeals</h3>
      <p>Under certain US state data protection laws, if we decline to take action regarding your request, you may appeal our decision by emailing us at <a href="mailto:info@mrprinterpro.shop">info@mrprinterpro.shop</a>. We will inform you in writing of any action taken or not taken in response to the appeal, including a written explanation of the reasons for the decisions. If your appeal is denied, you may submit a complaint to your state attorney general.</p>
      ...
      <p>If you have questions or comments about this notice, you may email us at <a href="mailto:info@mrprinterpro.shop">info@mrprinterpro.shop</a> or contact us by post at:</p>
      <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm my-8 not-prose shadow-sm">
        <address className="not-italic text-gray-700 font-bold leading-relaxed">
                     MrPrinterPro <br />          Authorized HP Partner<br />
